...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typingText) {
        ...
        typingText.style.borderRight = '2px solid #6366f1';
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const mailtoLink = `mailto:moeinghaeini@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
